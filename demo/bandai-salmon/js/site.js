/* 磐梯サーモン LP — サイト挙動（スクロール連動・環境差に強い） */
(function () {
  'use strict';
  ...
  function onScroll() {
    ...
    if (buybar) buybar.classList.toggle('is-visible', past);
    if (!counted && trust && trust.getBoundingClientRect().top < window.innerHeight * 0.85) {
      counted = true; runCount();
    }
  }
